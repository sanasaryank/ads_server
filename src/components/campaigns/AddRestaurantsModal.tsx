  ...
  const filteredRestaurants = useMemo(() => {
    return restaurants.filter((restaurant) => {
      ...
      if (filters.restaurantTypes.length > 0) {
        ...
        const matchesType = typeIds.some((typeId: number) => filters.restaurantTypes.includes(typeId));
      ...
      if (filters.menuTypes.length > 0) {
        ...
        const matchesMenuType = menuTypeIds.some((menuTypeId: number) => filters.menuTypes.includes(menuTypeId));
