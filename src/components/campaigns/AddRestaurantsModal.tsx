...
export const AddRestaurantsModal = memo(({
  ...
  const restaurantSelection = useDataSelection<number>();
          ...
          <Box>
            <FormControl component="fieldset" fullWidth>
              ...
              <Select
                ...
                options={districts.map((d) => ({ value: d.id, label: getDisplayName(d.name) }))}
                multiple
              />
            </FormControl>
          </Box>
          ...
          <Box>
            <FormControl component="fieldset" fullWidth>
              ...
              <Select
                ...
                options={restaurantTypes.map((t) => ({ value: t.id, label: getDisplayName(t.name) }))}
                multiple
              />
            </FormControl>
          </Box>
          ...
          <Box>
            <FormControl component="fieldset" fullWidth>
              ...
              <Select
                ...
                options={menuTypes.map((m) => ({ value: m.id, label: getDisplayName(m.name) }))}
                multiple
              />
            </FormControl>
          </Box>
