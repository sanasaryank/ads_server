...
export const RestaurantsListPage = memo(() => {
  ...
  // Populate advertisers store when data loads
  useEffect(() => {
  ...
  // Populate dictionaries store when data loads
  useEffect(() => {
    if (dictionaries) {
      setAllDictionaries({
        cities: dictionaries.cities as any,
        locations: dictionaries.districts as any,
        restaurantTypes: dictionaries.restaurantTypes,
        priceSegments: dictionaries.priceSegments,
        menuTypes: dictionaries.menuTypes,
