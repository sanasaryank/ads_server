...
import { useFetch, useFilters, useDrawer, useConfirmDialog, useMultilingualName, useDialogState, useDebounce } from '../../hooks';
...
export const SlotsListPage = memo(() => {
  ...
  }, [slots, applyFilters, filters, debouncedSearch, getDisplayName]);
