...
import { useTableState, useDebounce, useConfirmDialog, useDrawer, useFilters, useMultilingualName, useDialogState, useCampaignsData } from '../../hooks';
            ...
            {activeTab === 4 && (
              <TargetingTab
                ...
                campaignTargetingRules={{
                  ...
                  locations: (watchedLocationIds || []).map((id: string) => Number(id)),
                  restaurantTypesMode: watchedRestaurantTypesMode,
                  restaurantTypes: (watchedRestaurantTypeIds || []).map((id: string) => Number(id)),
                  menuTypesMode: watchedMenuTypesMode,
                  menuTypes: (watchedMenuTypeIds || []).map((id: string) => Number(id)),
                }}
              />
            )}
            </Box>
